...
- **ActionBar Style生成器**：[http://jgilfelt.github.io/android-actionbarstylegenerator/][141]
- **SVG转VectorDrawable**：[http://inloop.github.io/svg2android/][142]
- **在线.9图制作**：[http://romannurik.github.io/AndroidAssetStudio/nine-patches.html][143]
- **在线不同颜色风格的控件**：[http://android-holo-colors.com/][144]
- **px，dp，sp，pt 转换相关**：
[http://labs.rampinteractive.co.uk/android_dp_px_calculator/][145]
[http://angrytools.com/android/pixelcalc/][146]
[http://pixplicity.com/dp-px-converter/][147]
- **Grepcode**(源码搜索引擎)：[http://grepcode.com/search/?query=google+android&entity=project][148]
- **十进制与十六进制互转**：[http://www.binaryhexconverter.com/decimal-to-hex-converter][149]
- **APIStore**(收录各种日常API)：[http://apistore.baidu.com/][150]
- **在线绘制UML**(国外，有些慢，不过UI蛮好看的)：[https://cacoo.com/getstarted/][151]
- **ProcessOn**(国内，支持多种图，还不错)：[https://www.processon.com/][152]
- **马克鳗**(标注测量工具)：[http://www.getmarkman.com/][153]
**PxCook像素大厨**(UI设计利器)：[http://www.fancynode.com.cn/][154]


### Android Studio 插件

——以下内容摘自：[习惯沉默的Blog——Android Studio插件整理][155]，只贴概述，效果自行到博客查看。
...
- **ADB WIFI**，**AndroidWiFiADB**：wifi无线调试APP。
...
- **idea-markdown**，**Markdown Navigator**：Markdown插件。
- **Sexy Editor**：设置AS背景图。
...
- **Statistic**:文件行数统计
- **代码配色**：[http://color-themes.com/?view=index][156]

...如需查看更多可见：[http://mobdevgroup.com/tools/android][157]
